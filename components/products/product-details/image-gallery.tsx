    ...
    return (
        <div className="xxl:col-span-12 xl:col-span-6 lg:col-span-6 md:col-span-6 sm:col-span-12 col-span-12 md:mb-[3rem] mb-4">
            <Swiper
                ...
                modules={[FreeMode, Navigation, Thumbs, Autoplay]} className="rounded-md mySwiper2 swiper swiper-preview swiper-preview-details bg-light" >
            ...
            <Swiper onSwiper={(swiper)=>setThumbsSwiper(swiper)} autoplay={{ delay: 2500, disableOnInteraction: false, }} spaceBetween={10} slidesPerView={4} freeMode={true} watchSlidesProgress={true}
