                                            ...
                                            <div className="table-responsive">
                                                <table className="table min-w-full table-bordered whitespace-nowrap">
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            <td className="grid">
                                                                <button type="button" className="ti-btn ti-btn-primary !font-medium">
                                                                    View All Products
                                                                </button>
                                                            </td>
                                                        </tr>
                                                        ...
                                                        <div className="ecommerce-assurance">
                                                            <p className="inline-flex mb-4">
                                                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64">
                                                                    <linearGradient id="a" x1="32" x2="32" y1="63.723" y2=".835" gradientTransform="matrix(1 0 0 -1 0 63.89)" gradientUnits="userSpaceOnUse">
